...
cipherTexts.append(c1.decode("hex"))
cipherTexts.append(c2.decode("hex"))
cipherTexts.append(c3.decode("hex"))
cipherTexts.append(c4.decode("hex"))
cipherTexts.append(c5.decode("hex"))
cipherTexts.append(c6.decode("hex"))
cipherTexts.append(c7.decode("hex"))
cipherTexts.append(c8.decode("hex"))
cipherTexts.append(c9.decode("hex"))
cipherTexts.append(c10.decode("hex"))
